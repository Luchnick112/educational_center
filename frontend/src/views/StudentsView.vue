<template>
  <AppShell :title="isCreateRoute ? 'Створити учня' : 'Учні'">
...
const isCreateRoute = computed(() => route.name === 'students-create')
const DETAIL_QUERY_KEY = 'student'
const LIST_ROUTE_NAME = 'students'
