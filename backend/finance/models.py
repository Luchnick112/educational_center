...
class ParentCharge(models.Model):
    ...
    billing_period = models.PositiveIntegerField(default=1)
    lesson_count = models.PositiveSmallIntegerField(default=1)
    period_start_at = models.DateTimeField(null=True, blank=True)
    period_end_at = models.DateTimeField(null=True, blank=True)
